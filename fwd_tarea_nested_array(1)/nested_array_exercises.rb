...
chart3= [[nil, 'Bob', 'Joe'], [nil, nil, 'Bill']]
row_index=0
seat_index=1
p delete_seat_from_row(chart3, row_index, seat_index)
#-------------------------------------------------------------------------------------------------------------------
...
chart4=[[nil, 'Bob'], ['Joe', nil], [nil, 'Bill']]
row_index=1
p delete_row_from_chart(chart4, row_index)
...
chart5= [[nil, 'Bob', 'Joe'], [nil, nil, 'Bill']] 
p count_empty_seats(chart5)
